<?php
// HTTP
define('HTTP_SERVER', 'https://site.pardeep.app/admin/');
define('HTTP_CATALOG', 'https://site.pardeep.app/');

// HTTPS
define('HTTPS_SERVER', 'https://site.pardeep.app/admin/');
define('HTTPS_CATALOG', 'https://site.pardeep.app/');
